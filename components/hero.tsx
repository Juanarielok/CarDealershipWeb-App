        ...
        <div className="pt-36 md:pt-40 md:pb-20">
          ...
          <div className="relative max-w-xl mx-auto md:max-w-none text-center md:text-left">
            ...
            <div className="md:w-[600px]">
              ...
              This is the place where you will drive your {' '}
              ...
              Experience the extraordinary with our handpicked selection of exceptional cars,where every drive becomes a journey of luxury and performance.
